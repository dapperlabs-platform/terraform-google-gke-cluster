...
| [kubernetes_secret_v1.tokens](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret_v1) | resource |
...
| [kubernetes_storage_class.example](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/storage_class) | resource |
...
| <a name="input_managed_prometheus"></a> [managed\_prometheus](#input\_managed\_prometheus) | Enable Managed Service for Prometheus | `bool` | `null` | no |
